...
class AudioToTextRecorder:
    ...
    def _transcription_worker(conn,
        ...
        Raises:
            ...
            transcription model.
        """
        #model_path = "..\example_browserclient\whisper-th-small-ct2-int8-20240812T112710Z-001"
        ...
        try:
            #model = "..\example_browserclient\whisper-th-small-ct2-int8-20240812T112710Z-001"
                ...
                if conn.poll(0.5):
                    ...
                    try:
                        segments = model.transcribe(
                            ...
                            #beam_size=beam_size,
                            language=language if language else "th",
                            beam_size=beam_size,
